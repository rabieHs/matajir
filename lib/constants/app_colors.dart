...
class AppColors {
  ...
  // Background colors
  static const Color scaffoldBackground = Color(0xFF673AB7); // Purple gradient start
  static const Color scaffoldBackgroundEnd = Color(0xFF311B92); // Purple gradient end
